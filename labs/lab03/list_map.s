...
main:
    ...
    # a0 is the first argument, a1 is the second
    jal ra, map
...
map:
    ...
    ### YOUR CODE HERE ###
    #jalr jumps to the address defined by the register
    jalr s1
    ...
    ### YOUR CODE HERE ###
    # s0 is the pointer the the value of current node, which takes up 4 bytes
    # thus, the next attribute, the pointer to the next node, is 4 + s0
    lw a0, 4(s0)
